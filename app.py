...
def start_program(program_name):
    if program_name == "index":
        subprocess.Popen("cd ~/index; ulimit -c unlimited; ulimit -n 4096; ./index chunks 5000 2> errs 1> /dev/null ", shell=True)
        ...
        subprocess.Popen("cd ~/crawler; ulimit -c unlimited; ulimit -n 4096; export INDEX_HOST=" + index_host + "; export INDEX_PORT=" + index_port +
